...
function Data() {
  ...
  const addtoCart = (data) => {
    fetch("https://myntajsonserver.herokuapp.com/item",
      {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      {detailBool ? <><Header /><hr />
            ...
            <button onClick={() => {
               addtoCart(detail);
                setNavigate(true)
                   ...
                   <LocalMallSharpIcon />  ADD TO BAG</button>
        ...
        <>
          {loading ? <div> 
            <h1 className="loading-1">Loading....</h1>
            <CircularProgress className="product-loading" disableShrink />;
            </div> 
          
          : error ? <div>
            <h1 className="loading-1" >Error....</h1>
            </div>
                ...
                <div className="left">
                  ...
                  <div className="product-radio">
                    <form >
                      ...
                      <label>
                        <input  type="radio"  value="female" /><b>women</b>
                      </label><br />
                      <label>
                        <input type="radio"  value="male" /><b>Boys</b>
                      </label><br />
                      <label>
                        <input  type="radio" value="male"  /><b>Girls</b>
                      </label><br />
                  ...
                  <div className="product-radio">
                    <form > 
                      ...
                      <label>
                        <input  type="checkbox"  value="male"  />Jeans(159)
                      </label><br />
                      <label>
                      ...
                      <label>
                        <input type="checkbox"  value="male" />Dresses(11)
                      </label><br />
                      <label>
                        <input  type="checkbox" value="male"  />Tops(45)
                      </label><br />
                  ...
                  <div className="product-radio">
                    ...
                    <form >
                      <label>
                        <input
                          type="checkbox"  value="male"  />Rs. 449 to Rs. 1987(245)
                      </label><br />
                      <label>
                        <input
                          type="checkbox"  value="female" />Rs. 1987 to Rs. 3525(93)
                      </label><br />
                      <label>
                        <input type="checkbox"  value="male"  />Rs. 3525 to Rs. 5063(2)
                      </label><br />
                      <label>
                        <input type="checkbox" value="male"  /> Rs. 5063(2)+
                      </label><br />
                    </form>
